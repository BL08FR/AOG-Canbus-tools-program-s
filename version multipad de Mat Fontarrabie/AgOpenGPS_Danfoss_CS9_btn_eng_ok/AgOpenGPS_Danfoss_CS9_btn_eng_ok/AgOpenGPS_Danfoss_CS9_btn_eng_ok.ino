...
//------------------------------------
//Valtra / Massey Ferguson CANBUS AOGv5 - (Tony's Version)
//Only connected to Steering-Bus 
//Button Steer Engage - Via PCB (Non Factory Switch) or CAN (Factory Switch)
...
digitalWrite(engageLED,LOW);
 ...
 pinMode(CAN0_INT, INPUT);;             // Setting CAN0_INT as input
  ...
  CAN0.init_Filt(3,1,0x98EF1C00);       // Init fouth filter...
