...
//------------------------------------
//Valtra + Massey Fergurson CAN-BUS AOGv5 9.5.2021 - (Tony's Version)
...
/////////////////////////////////////////////
  ...
  uint8_t thisEnc = 0, lastEnc = 0;
   ...
   struct Storage {
      ...
      int16_t wasOffset = 0;// orignal value = 0
      uint8_t minPWM = 9;
...
//--------CAN-Void-Setup-Start------
  ...
  digitalWrite(engageLED,LOW);
   ...
   CAN0.init_Filt(2,1,0x18EF1C00);       // Init third filter...
   CAN0.init_Filt(3,1,0x18EF1C00);       // Init fouth filter...
   CAN0.init_Filt(4,1,0x18EF1C00);       // Init fifth filter...
   CAN0.init_Filt(5,1,0x18EF1C00);       // Init sixth filter...
